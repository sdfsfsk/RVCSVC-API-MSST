...
def _stream_reader(pipe, log_func, prefix="", filter_tqdm=False):
    last_progress = ""
    try:
...
def separate_vocal_subprocess(input_audio_path, output_dir=None, output_format='wav', model_path=None, config_path=None,
                              inference_params=None, model_name=None):
    ...
    try:
        ...
        stdout_thread = threading.Thread(
            target=_stream_reader, args=(proc.stdout, logger.info, "", True), daemon=True
        )
